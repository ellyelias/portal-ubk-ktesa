...
export default function HomeCoretan(){
 ...
 <div className="section-heading coretan-heading-row"><div><span>CORETAN KAUNSELOR</span><h2>Secebis kata<br/>untuk anda.</h2></div>
 <Link href="/coretan">Lihat semua coretan <ArrowRight size={16}/></Link></div>
