...
export default function LaluanPage(){
 ...
 const item=careers[selected]; const requirements=selected==="peguam"?lawComparisons[selectedLaw]:selected==="jurutera"?engineeringComparisons[selectedEngineering]:selected==="guru"?educationComparisons[selectedEducation]:selected==="akauntan"?financeComparisons[selectedFinance]:selected==="matematik"?mathComparisons[selectedMath]:selected==="sains"?scienceComparisons[selectedScience]:selected==="perniagaan"?businessComparisons[selectedBusiness]:comparisons[selected]; const packageItem=packages[selectedPackage];
