...
const careers = {
  ...
  doktor: {
    ...
    official:"Pilih cabang dahulu kerana Perubatan, Veterinar, Pergigian, Farmasi dan Sains Kesihatan mempunyai syarat yang berbeza. Gunakan pemilih subprogram di bawah untuk perbandingan terperinci Perubatan, Pergigian, Farmasi dan Kejururawatan. Nota pertindihan: Farmasi turut mempunyai kad bidang kerjaya berasingan (key farmasi) dengan baris UM/UKM tambahan; Veterinar mempunyai bidang berasingan (key veterinar); Fisioterapi, Terapi Cara Kerja, Pengimejan, Audiologi, Dietetik dan Sains Bioperubatan disenaraikan di bawah Kesihatan Bersekutu (key kesihatanbersekutu).",
  ...
  teknologi: {
    ...
    official:"Contoh Sains Komputer UM 2026: PNGK minimum 3.00 aliran Sains, B- dalam Mathematics dan B- dalam satu subjek Sains yang diterima; MUET Band 3.5. Gunakan pemilih subprogram di bawah untuk melihat perbandingan khusus Sains Komputer, Kejuruteraan Perisian, AI, Sains Data, Keselamatan Siber, Sistem Maklumat, Rangkaian Komputer dan Multimedia/Media Interaktif.",
  ...
  kesihatanbersekutu: {
    ...
    official:"UKM ialah universiti utama bagi tujuh daripada lapan program asal ini (Biomedical Science, Dietetics, Physiotherapy, Occupational Therapy, Diagnostic Imaging & Radiotherapy, Audiology, Environmental & Occupational Health), dengan UPM menawarkan Biomedical Sciences dan Nutrition and Community Health. Kemas kini: tiga subprogram baharu ditambah — Optometri (UKM Bachelor of Optometry), Sains Pertuturan (UKM Bachelor of Speech Science) dan Teknologi Makmal Perubatan (UiTM HS241) — serta satu baris tambahan bagi Sains Bioperubatan (UM Bachelor of Biomedical Science, PNGK 3.50). Tiada satu pun program yang lain menerbitkan angka PNGK minimum khusus. Nota: subjek Kesihatan Alam Sekitar & Pekerjaan juga muncul di bawah bidang Alam Sekitar & Kelestarian — kandungan sama, dua bidang berasingan.",
  ...
  bahasa: {
    name:"Bahasa, Linguistik & Terjemahan", course:"Bahasa Melayu / Linguistik / Bahasa Inggeris / Terjemahan / Kesusasteraan / Bahasa untuk Komunikasi Profesional", stream:"Terbuka kepada aliran Sains atau Sains Sosial mengikut program.",
    spm:["Bahasa Melayu dan Bahasa Inggeris penting.","Program tertentu menilai kekuatan bahasa khusus seperti Bahasa Arab atau Bahasa Inggeris."],
    stpm:["Bahasa Melayu, Sejarah atau subjek bahasa/sastera memberi asas yang baik.","MUET mengikut program dan universiti."],
    target:"Sasarkan keputusan bahasa yang kuat dan PNGK sekurang-kurangnya 3.00 untuk pilihan lebih luas. Program komunikasi profesional memerlukan keupayaan menulis dan bertutur yang baik.",
    official:"UM (Professional Malay Language, Malay Linguistics, Malay Literature, Malay Studies), UKM (English Language Studies, Linguistics, Malay Language Studies), USM (English for Professionals, Bachelor of Arts pengkhususan Malay Language Linguistics/English Language Studies/Literature) dan UiTM (LG240–LG243 Language for Professional/Intercultural Communication, dikemas kini 4 September 2026) ialah sumber utama; tiada satu pun menerbitkan PNGK minimum khusus. Nota kemas kini: cabang Komunikasi Massa, Kewartawanan, Perhubungan Awam, Penyiaran & Produksi dan Media Baharu digugurkan daripada bidang ini kerana kini disatukan sepenuhnya di bawah bidang berasingan \"Media, Komunikasi & Industri Kreatif\" (key media).",
    source:"https://study.um.edu.my/"
  },
  bina: {
    name:"Alam Bina", course:"Seni Bina / Ukur Bahan / Perancangan Bandar / Seni Bina Landskap / Geomatik / Geoinformatik / Pembinaan", stream:"Terbuka kepada aliran Sains dan sesetengah aliran Sains Sosial mengikut program.",
    spm:["Matematik sangat penting; sesetengah program turut menilai Matematik Tambahan atau Fizik.","Seni Visual/Lukisan Kejuruteraan boleh menjadi kelebihan bagi program reka bentuk."],
    stpm:["Mathematics / Physics / Geography / Economics / Visual Arts atau subjek diterima mengikut program","MUET mengikut universiti"],
    target:"Sasarkan PNGK 3.00 ke atas untuk lebih banyak pilihan. Program Seni Bina boleh mempunyai ujian, portfolio atau temu duga.",
    official:"UTM ialah universiti utama (Architecture, Quantity Surveying, Urban & Regional Planning, Landscape Architecture, Geomatics Engineering, Geoinformatics, Construction), dengan USM (HBP — 7 program termasuk Building Surveying, Construction Project Management, Interior Architecture) dan UPM (Architecture, Landscape Architecture) turut aktif; hanya UTM Architecture menerbitkan PNGK minimum (3.00). Nota kemas kini: cabang \"Hartanah\" digugurkan kerana tiada program ijazah Hartanah berasingan disahkan dalam bundle ini; Geomatik & Geoinformatik kini dipecahkan kepada dua cabang berasingan (Kejuruteraan Geomatik; Geoinformatik & GIS). Nota pertindihan: cabang \"Seni Bina\" dan \"Seni Bina Landskap\" turut wujud di bawah bidang Seni, Reka Bentuk & Kreatif (key kreatif, dari v57) — Alam Bina ialah rujukan utama untuk program profesional berkaitan seni bina/landskap.",
    source:"https://admission.utm.my/undergraduate-kit/"
  },
  hospitaliti: {
    name:"Hospitaliti & Pelancongan", course:"Pengurusan Hospitaliti / Pelancongan / Acara / Seni Kulinari / Perkhidmatan Makanan / Pengurusan Destinasi", stream:"Terbuka kepada aliran Sains atau Sains Sosial mengikut program.",
    spm:["Bahasa Melayu, Bahasa Inggeris dan Matematik perlu diberi perhatian.","Bidang hospitaliti dan pelancongan sangat menekankan komunikasi, khidmat pelanggan dan kemahiran praktikal."],
    stpm:["Kebanyakan program menerima pelbagai kombinasi STPM.","MUET dan syarat Bahasa Inggeris berbeza mengikut universiti."],
    target:"Sasarkan PNGK sekurang-kurangnya 3.00 untuk pilihan lebih luas walaupun sesetengah program menetapkan minimum yang lebih rendah. Kemahiran komunikasi dan pengalaman industri sangat membantu.",
    official:"UiTM (HM260 Hospitality, HM261 Tourism, HM262 FoodService, HM265 Culinary Arts), UUM (Hospitality Management UU6811001, Event Management UU6812002) dan UMT (Tourism Management) ialah universiti utama yang disahkan aktif 2026; tiada satu pun menerbitkan PNGK minimum khusus. Nota: dokumen syarat UiTM iCEPS 2025 (contoh PNGK 2.00) digunakan hanya sebagai rujukan sejarah, bukan syarat automatik laluan perdana 2026.",
    source:"https://online.uitm.edu.my/degree.cfm"
  },
  logistik: {
    name:"Logistik, Pengangkutan & Maritim", course:"Logistik & Rantaian Bekalan / Pengangkutan / Pengurusan Operasi / Pengurusan Maritim / Operasi Maritim / Sains Nautika", stream:"Terbuka kepada aliran Sains atau Sains Sosial mengikut program.",
    spm:["Matematik sangat penting bagi hampir semua laluan logistik dan pengangkutan.","Bahasa Inggeris penting untuk dokumentasi perdagangan, pelabuhan, perkapalan dan komunikasi industri."],
    stpm:["Economics / Business Studies / Accounting / Geography / Mathematics boleh menjadi subjek penting.","MUET mengikut universiti dan program."],
    target:"Sasarkan PNGK 3.00 ke atas untuk pilihan lebih luas. Bezakan pengurusan logistik darat, pengurusan operasi dan laluan maritim/nautika kerana syarat serta kerjayanya tidak sama.",
    official:"UUM (Logistics and Transportation UU6840001), UiTM (BA277 Transport, BA274 Operations Management) dan UMT (Maritime Management, Maritime Operations Management — PNGK minimum 2.75, Nautical Science & Maritime Transportation) ialah universiti utama yang disahkan aktif 2026. Nota pertindihan: cabang \"Rantaian Bekalan\" turut wujud sebagai satu daripada lapan cabang generik di bawah bidang Perniagaan & Pengurusan (key perniagaan) — bidang ini ialah rujukan utama untuk laluan logistik/pengangkutan/maritim yang lebih khusus dan disahkan dengan program sebenar.",
    source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-business-administration-logistics-and-transportation-with-honours"
  },
  sosial: {
  ...
  senipersembahan: {
    name:"Seni Persembahan & Muzik", course:"Muzik / Lakonan & Pengarahan / Teater & Produksi / Filem & Produksi Skrin / Pengurusan Seni & Produksi", stream:"Terbuka kepada pelbagai aliran, tetapi hampir semua program mewajibkan audisi, ujian kemahiran dan/atau temu duga.",
    spm:["Bahasa Melayu dan Bahasa Inggeris perlu memenuhi syarat am universiti.","Kelayakan muzik yang diiktiraf (contoh ABRSM/Trinity Grade 5, Yamaha Grade 7, LTCL, ATCL) atau sekurang-kurangnya B- Muzik SPM membantu bagi laluan Muzik."],
    stpm:["Kebanyakan program menerima pelbagai kombinasi STPM.","Audisi, ujian kemahiran dan temu duga adalah wajib bagi hampir semua program."],
    target:"Sediakan portfolio/audisi yang kukuh dan kelayakan muzik formal jika berkaitan. Sasarkan PNGK 2.00–3.00 ke atas mengikut program serta latihan praktikal yang konsisten.",
    official:"USM Bachelor of Music mensyaratkan PNGK minimum 2.00, minimum C dalam dua subjek, MUET Band 3.0, kelayakan muzik yang diiktiraf serta temu duga dan audisi/ujian kemahiran wajib (disahkan pada halaman rasmi USM); USM Bachelor of Fine Arts (Acting and Directing) turut memerlukan audisi dan temu duga; UiTM Bachelor of Theatre (Honours) Theatre Production ialah sumber utama bagi Teater & Produksi. Nota: bidang ini berasingan daripada Seni, Reka Bentuk & Kreatif (key kreatif) yang menumpukan seni visual, reka bentuk dan media — tiada pertindihan cabang.",
    source:"https://arts.usm.my/index.php/programmes/undergraduate"
  },
  pertahanan: {
    name:"Pengajian Strategik, Pertahanan & Keselamatan", course:"Pengajian Strategi / Pengurusan Pertahanan & Keselamatan / Pengurusan Sumber Manusia Pertahanan / Hubungan Antarabangsa (Diplomasi & Keselamatan) / Keselamatan Global & Analitik / Rantaian Bekalan & Logistik Pertahanan", stream:"Terbuka kepada aliran Sains Sosial dan sesetengah aliran Sains, tertakluk syarat UPNM.",
    spm:["Memenuhi syarat am SPM universiti; Bahasa Inggeris penting untuk laluan diplomasi dan hubungan antarabangsa."],
    stpm:["Program disenaraikan secara rasmi oleh UPNM; kombinasi subjek STPM khusus perlu disemak dalam buku syarat 2026–2029."],
    target:"Sasarkan PNGK yang kukuh serta minat dalam dasar awam, analisis dan hubungan antarabangsa. Bidang ini tertumpu sepenuhnya kepada laluan akademik, dasar, diplomasi, pentadbiran, analitik dan penyelidikan — tiada kandungan operasi, senjata, taktikal atau aktiviti berbahaya.",
    official:"Universiti Pertahanan Nasional Malaysia (UPNM) ialah universiti utama bagi keenam-enam program ini; tiada satu pun menerbitkan angka PNGK minimum khusus pada ringkasan program semasa — rujuk buku syarat kemasukan UPNM 2026–2029 untuk kombinasi gred tepat. Nota pertindihan: cabang Hubungan Antarabangsa/Diplomasi berkait rapat dengan bidang Pentadbiran Awam, Politik & Hubungan Antarabangsa (key pentadbiran, terutamanya cabang \"Diplomasi, Strategik & Keselamatan Antarabangsa\"); cabang Rantaian Bekalan & Logistik Pertahanan berkait rapat dengan bidang Logistik, Pengangkutan & Maritim (key logistik). Bidang ini kekal berasingan kerana tertumpu khusus kepada laluan akademik UPNM.",
    source:"https://www.upnm.edu.my/index.php/bm/kemasukan/program-pengajian/pra-siswazah"
  }
} as const;
...
const careerBranches:Record<CareerKey,Branch[]>={
 ...
 kesihatanbersekutu:[
  ...
  {name:"Optometri",study:"Penglihatan, pemeriksaan mata, lensa korektif dan pengurusan masalah visual",careers:"Pegawai optometri, optometris klinikal"},
  {name:"Sains Pertuturan / Terapi Pertuturan-Bahasa",study:"Komunikasi, pertuturan, bahasa dan rehabilitasi pertuturan",careers:"Ahli terapi pertuturan-bahasa, pegawai sains pertuturan"},
  {name:"Teknologi Makmal Perubatan",study:"Analisis sampel klinikal, hematologi, mikrobiologi dan patologi makmal untuk membantu diagnosis",careers:"Juruteknologi makmal perubatan"}
 ],
 alam:[
 ...
 bahasa:[
  {name:"Bahasa Melayu",study:"Tatabahasa, wacana, budaya, bahasa profesional, penyuntingan dan penyelidikan",careers:"Pegawai bahasa, editor, penulis, penyelidik bahasa"},
  {name:"Linguistik",study:"Fonetik, fonologi, morfologi, sintaksis, semantik, sosiolinguistik dan psikolinguistik",careers:"Pegawai bahasa, linguistic analyst, penyelidik, language technologist"},
  {name:"Bahasa Inggeris",study:"English language, linguistics, discourse, communication dan applied language studies",careers:"Editor, language executive, corporate communication officer, content specialist"},
  {name:"Terjemahan & Bahasa Asing",study:"Terjemahan, interpreting, budaya, penyuntingan, localization dan bahasa asing",careers:"Penterjemah, interpreter, localization specialist, language officer"},
  {name:"Kesusasteraan",study:"Kritikan sastera, teks, budaya, sejarah kesusasteraan dan penulisan",careers:"Editor, penulis, penyelidik, pegawai penerbitan"},
  {name:"Bahasa untuk Komunikasi Profesional",study:"Penulisan profesional, komunikasi korporat, bahasa tempat kerja dan komunikasi antara budaya",careers:"Communication executive, language trainer, corporate writer, content specialist"}
 ],
 bina:[
  {name:"Seni Bina",study:"Studio reka bentuk, teknologi binaan, sejarah, teori, struktur dan alam sekitar",careers:"Architectural assistant, BIM modeller, design assistant"},
  {name:"Ukur Bahan",study:"Kos, kontrak, tender, procurement, value management dan pengurusan projek",careers:"Quantity surveyor, cost consultant, contract executive"},
  {name:"Perancangan Bandar & Wilayah",study:"Guna tanah, pengangkutan, bandar, perumahan, GIS, pembangunan dan komuniti",careers:"Town planner, planning officer, development planner"},
  {name:"Seni Bina Landskap",study:"Reka bentuk ruang luar, ekologi, tapak, taman dan urban landscape",careers:"Landscape architect, landscape designer, parks planner"},
  {name:"Kejuruteraan Geomatik",study:"Ukur tanah, GNSS, remote sensing, pemetaan, geodesi dan data geospatial",careers:"Geomatics engineer, land surveyor pathway, geospatial officer"},
  {name:"Geoinformatik & GIS",study:"GIS, remote sensing, spatial databases, pemetaan digital dan analisis geospatial",careers:"GIS analyst, geospatial data specialist, mapping officer"},
  {name:"Pengurusan / Sains Pembinaan",study:"Construction technology, project management, safety, cost, scheduling dan quality",careers:"Construction manager, project executive, site coordinator"}
 ],
 matematik:[
 ...
 hospitaliti:[
  {name:"Pengurusan Hospitaliti",study:"Operasi hotel, front office, housekeeping, food & beverage, service quality dan revenue management",careers:"Hotel executive, front office manager, resort executive, hospitality manager"},
  {name:"Pengurusan Pelancongan",study:"Destinasi, pemasaran, tingkah laku pelancong, tour operations, transport dan pembangunan produk",careers:"Tourism officer, travel executive, destination planner, tourism marketer"},
  {name:"Pengurusan Acara",study:"Perancangan, bajet, protokol, pemasaran, risiko, MICE dan event operations",careers:"Event executive, conference coordinator, protocol officer, event manager"},
  {name:"Seni Kulinari",study:"Teknik masakan, menu, gastronomi, food safety, inovasi produk dan operasi dapur",careers:"Chef, R&D chef, culinary executive, food entrepreneur"},
  {name:"Pengurusan Perkhidmatan Makanan",study:"Food service operation, menu planning, purchasing, mass food production, quality dan entrepreneurship",careers:"Food service manager, F&B executive, QA officer, institutional catering manager"},
  {name:"Pengurusan Destinasi & Pelancongan Pesisir",study:"Island/coastal tourism, heritage, ecotourism, transport, reservation systems dan destination development",careers:"Destination manager, tourism planner, ecotourism officer, resort operations executive"}
 ],
 logistik:[
 ...
 senipersembahan:[
  {name:"Muzik",study:"Teori muzik, prestasi, komposisi, pedagogi muzik dan praktikal studio/ensembel",careers:"Pemuzik profesional, guru muzik, penggubah, pengarah muzik"},
  {name:"Lakonan & Pengarahan",study:"Teknik lakonan, pengarahan, teori drama, studio dan produksi persembahan",careers:"Pelakon, pengarah, jurulatih lakonan, artistik direktor"},
  {name:"Teater & Produksi",study:"Produksi pentas, reka bentuk set/lampu/bunyi, pengurusan produksi dan teater gunaan",careers:"Pengurus produksi, jurutera pentas, pereka set/lampu, stage manager"},
  {name:"Filem / Produksi Skrin",study:"Penulisan skrip, sinematografi, penyuntingan, pengarahan filem dan produksi skrin",careers:"Pembikin filem, pengarah, penulis skrip, editor filem"},
  {name:"Pengurusan Seni & Produksi",study:"Pengurusan acara seni, pentadbiran seni, pemasaran budaya dan pengeluaran persembahan",careers:"Pengurus seni, pegawai produksi, pentadbir persembahan, perancang acara budaya"}
 ],
 pertahanan:[
  {name:"Pengajian Strategi",study:"Dasar pertahanan, strategi keselamatan, analisis geopolitik dan penyelidikan strategik",careers:"Penganalisis strategik, pegawai dasar pertahanan, penyelidik keselamatan"},
  {name:"Pengurusan Pertahanan & Keselamatan",study:"Pengurusan organisasi pertahanan, dasar keselamatan dan pentadbiran",careers:"Pegawai pengurusan pertahanan, pentadbir keselamatan, pegawai dasar"},
  {name:"Pengurusan Sumber Manusia Pertahanan",study:"HR, latihan, pembangunan organisasi dalam konteks pertahanan",careers:"Pegawai HR pertahanan, pegawai latihan, pegawai pembangunan organisasi"},
  {name:"Hubungan Antarabangsa (Diplomasi & Keselamatan)",study:"Diplomasi, hubungan luar, keselamatan antarabangsa dan dasar luar",careers:"Pegawai diplomatik, penganalisis hubungan antarabangsa, pegawai hal ehwal luar"},
  {name:"Keselamatan Global & Analitik",study:"Analitik keselamatan, dasar awam, penyelidikan risiko global dan perisikan strategik",careers:"Penganalisis keselamatan global, pegawai risiko, penyelidik dasar"},
  {name:"Rantaian Bekalan & Logistik Pertahanan",study:"Logistik, perolehan, rantaian bekalan dan pengurusan operasi pertahanan",careers:"Pegawai logistik pertahanan, pegawai perolehan, pengurus operasi rantaian bekalan"}
 ]
};
const comparisons:Record<CareerKey,Requirement[]>={
 ...
 doktor:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Doktor Perubatan",pngk:3.80,spm:"Minimum B: Biologi, Kimia, Fizik, Matematik/Matematik Tambahan dan 1 subjek lain",stpm:"Minimum B: Biologi, Kimia dan Fizik/Mathematics",muet:"Tiada makluman rasmi bagi laluan STPM (Band 4.0 dalam dokumen rujukan nampaknya untuk laluan Asasi/SPM — disahkan semula Sept 2026)",extra:"Temu duga",source:"https://www.ukm.my/sppfper/wp-content/uploads/2023/03/Medicine-2023-UPU_compressed.pdf"},
  ...
  {uni:"Universiti Sains Malaysia (USM)",program:"Doktor Perubatan (MD)",pngk:3.50,spm:"Syarat khusus Sains dan Matematik",stpm:"Kombinasi subjek Sains yang ditetapkan",muet:"Band 3.0",extra:"Temu duga wajib; pemilihan kompetitif",source:"https://admission.usm.my/"},
 ...
 bina:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Science in Architecture with Honours",pngk:3.00,spm:"Kepujian Matematik",stpm:"Minimum Gred B dalam mana-mana dua subjek diterima seperti Mathematics M/T, Physics, Chemistry, Biology, Geography, History, Economics, Visual Arts, Accounting, Business, ICT atau Sports Science",muet:"Band 2.0",extra:"Ujian dan temu duga wajib bagi syarat kemasukan Malaysia 2026/2027",source:"https://admission.utm.my/wp-content/uploads/sites/461/2026/02/SYARAT-KHAS-SARJANA-MUDA-UTM-SESI-20262027.pdf"},
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Quantity Surveying with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk intake September 2026/2027",muet:"Mengikut syarat rasmi program",extra:"Fokus cost management, procurement, contracts dan value for money",source:"https://builtsurvey.utm.my/academic/undergraduate/quantity-surveying/"},
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Urban and Regional Planning with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk intake September 2026/2027",muet:"Mengikut syarat rasmi program",extra:"Interdisciplinary: neighbourhood, city, regional and national planning",source:"https://builtsurvey.utm.my/academic/undergraduate/urban-regional-planning/"},
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Landscape Architecture with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk September 2026",muet:"Mengikut syarat rasmi program",extra:"Menggabungkan art and science dalam reka bentuk ruang luar",source:"https://builtsurvey.utm.my/academic/undergraduate/landscape-architecture/"},
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Geomatics Engineering with Honours",pngk:null,spm:"Kepujian Bahasa Melayu/Bahasa Malaysia mengikut syarat am UTM",stpm:"Sekurang-kurangnya Gred C dalam Pengajian Am dan Gred C dalam dua subjek lain menurut halaman program",muet:"Sekurang-kurangnya Band 1 pada halaman program; semak syarat 2026/2027 semasa",extra:"Geospatial data, satellites, remote sensing, GPS dan surveying",source:"https://builtsurvey.utm.my/academic/undergraduate/geomatic/"},
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Science Geoinformatics with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk intake September 2026",muet:"Mengikut syarat rasmi semasa",extra:"Menggunakan IT untuk mengurus, memproses dan menganalisis maklumat geospatial",source:"https://builtsurvey.utm.my/fabu2024/academic/bachelor-of-science-geoinformatics/"},
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Science in Construction with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk September 2026",muet:"Mengikut syarat rasmi program",extra:"Program disenaraikan dalam kit intake 2026/2027",source:"https://admission.utm.my/undergraduate-kit/"}
 ],
 hospitaliti:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Science in Hospitality Management (Honours) — HM260",pngk:null,spm:"Memenuhi syarat am UiTM; syarat khas semasa perlu disemak melalui UPU/UiTM",stpm:"Program aktif pada 2026. Dokumen iCEPS 2025 menetapkan PNGK 2.00 dan Gred C dalam tiga subjek termasuk Pengajian Am; syarat ini tidak dianggap automatik untuk laluan perdana 2026",muet:"Mengikut syarat rasmi semasa",extra:"Program aktif di Faculty of Hotel and Tourism Management",source:"https://online.uitm.edu.my/degree.cfm"},
  {uni:"Universiti Utara Malaysia (UUM)",program:"Bachelor of Hospitality Management with Honours — UU6811001",pngk:null,spm:"Minimum lulus Mathematics / Additional Mathematics / Prinsip Perakaunan",stpm:"Menerima STPM Sastera atau Sains; syarat tambahan Bahasa Inggeris/MUET perlu dipenuhi",muet:"Band 3.0, atau Band 2.0 dengan sekurang-kurangnya kredit C Bahasa Inggeris SPM",extra:"8 semester",source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-hospitality-management-with-honours"},
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Bachelor of Management (Tourism) with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UMT",stpm:"Program aktif; syarat khusus sesi semasa perlu disemak",muet:"Mengikut syarat rasmi UMT",extra:"6 semester / 3 tahun · fokus island and coastal tourism, MICE/event, heritage, tourism transport dan reservation systems",source:"https://www.umt.edu.my/sarjana-muda-pengurusan-pelancongan-dengan-kepujian-fpeps/"},
  {uni:"Universiti Utara Malaysia (UUM)",program:"Bachelor of Event Management with Honours — UU6812002",pngk:null,spm:"Minimum lulus Mathematics / Additional Mathematics / Prinsip Perakaunan",stpm:"Menerima STPM Sastera atau Sains",muet:"Band 3.0, atau Band 2.0 dengan sekurang-kurangnya kredit C Bahasa Inggeris SPM",extra:"8 semester · program berasingan daripada Hospitality Management",source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-event-management-with-honours"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Science in Culinary Arts Management (Honours) — HM265",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Program aktif pada 2026; syarat khusus laluan perdana perlu disemak melalui UPU/UiTM",muet:"Mengikut syarat rasmi program",extra:"Menu design, advanced cooking, culinary innovation, food safety dan industrial training",source:"https://fhtm.uitm.edu.my/index.php/academics/programmes/undergraduate/culinary-arts-management"},
  {uni:"Universiti Putra Malaysia (UPM)",program:"Bachelor of Science in Food Service Management with Honours",pngk:null,spm:"Kepujian Bahasa Melayu/Bahasa Malaysia dan syarat am universiti",stpm:"Syarat am menerbitkan sekurang-kurangnya Gred C Pengajian Am dan Gred C dalam dua subjek lain; syarat khas perlu disemak semasa",muet:"Perlu mengambil MUET; band khusus mengikut syarat semasa",extra:"8 semester / 4 tahun · kerjaya termasuk F&B, service management, marketing, QA dan chef",source:"https://food.upm.edu.my/akademik/prasiswazah/bacelor_sains_pengurusan_perkhidmatan_makanan_dengan_kepujian-1149"}
 ],
 logistik:[
  {uni:"Universiti Utara Malaysia (UUM)",program:"Bachelor of Business Administration (Logistics and Transportation) with Honours — UU6840001",pngk:null,spm:"Kredit C Mathematics/Additional Mathematics, atau lulus Mathematics/Add Mathematics + kredit C dalam Accounting/Economics/Commerce/Business",stpm:"Menerima STPM Sastera atau Sains; syarat penuh mengikut halaman rasmi program",muet:"Band 3.0, atau Band 2.0 bersama kredit Bahasa Inggeris SPM",extra:"8 semester",source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-business-administration-logistics-and-transportation-with-honours"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Business in Transport (Honours) — BA277",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Program aktif 2026; syarat rasmi laluan STPM perlu disemak melalui UiTM/UPU",muet:"Mengikut syarat rasmi program",extra:"Program aktif di Faculty of Business and Management; turut mempunyai laluan operasi dan supply chain",source:"https://fbm.uitm.edu.my/index.php/programmes"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Business in Operations Management (Honours) — BA274",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Program aktif pada 2026",muet:"Mengikut syarat rasmi UiTM",extra:"Department of Technology and Supply Chain Management Studies",source:"https://fbm.uitm.edu.my/index.php/programmes"},
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Bachelor of Management (Maritime) with Honours",pngk:null,spm:"Minimum E Bahasa Inggeris; Mathematics SPM minimum C boleh digunakan bagi salah satu laluan",stpm:"Minimum B- dalam satu daripada Economics/Geography/Accounting/Business Studies dan minimum C Mathematics STPM, ATAU minimum C Mathematics SPM",muet:"Band 2.0",extra:"7 semester / 3.5 tahun · termasuk 1 tahun Work-Based Learning di pelabuhan terpilih",source:"https://www.umt.edu.my/sarjana-muda-pengurusan-maritim-dengan-kepujian-fpm/?lang=ms"},
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Bachelor of Management (Maritime Operation) with Honours",pngk:2.75,spm:"Minimum C Mathematics dan minimum C Bahasa Inggeris, jika syarat Mathematics dipenuhi di peringkat SPM",stpm:"STPM Sains atau Sastera; PNGK minimum 2.75; minimum C dalam Additional Mathematics/Mathematics atau alternatif Mathematics SPM minimum C",muet:"Band 3.0",extra:"6 semester / 3 tahun · port & terminal, warehouse, fleet, customs, cargo, safety dan supply chain",source:"https://www.umt.edu.my/sarjana-muda-pengurusan-operasi-maritim-dengan-kepujian-fpm/"},
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Bachelor of Science (Nautical Science and Maritime Transportation) with Honours",pngk:null,spm:"Memenuhi syarat khas program termasuk keperluan akademik/kesihatan yang ditetapkan",stpm:"Program aktif; semak syarat kemasukan rasmi sesi semasa",muet:"Mengikut syarat rasmi UMT",extra:"8 semester / 4 tahun · dibangunkan berasaskan modul kompetensi pegawai navigasi kapal IMO",source:"https://www.umt.edu.my/sarjana-muda-sains-sains-nautika-dan-pengangkutan-maritim-dengan-kepujian-fpm/"}
 ],
 alam:[
 ...
 bahasa:[
  {uni:"Universiti Malaya (UM)",program:"Bachelor of Professional Malay Language / Bachelor of Malay Linguistics / Bachelor of Malay Literature / Bachelor of Malay Studies",pngk:null,spm:"Memenuhi syarat am dan syarat khas Academy of Malay Studies",stpm:"Program aktif; syarat khusus perlu disemak pada halaman kemasukan semasa",muet:"Mengikut syarat rasmi UM",extra:"Empat program berasingan masih disenaraikan dalam senarai akademik UM 2025/2026",source:"https://study.um.edu.my/"},
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Arts in Malay Language Studies with Honours",pngk:null,spm:"Memenuhi syarat am UKM dan syarat khas program",stpm:"Program aktif untuk pengambilan September",muet:"Mengikut syarat program",extra:"Program disenaraikan dalam FSSK dan UKM FlexEd 2026/2027",source:"https://www.ukm.my/studyukm/faculty-of-social-sciences-and-humanities/"},
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Social Sciences in Linguistics with Honours",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khas FSSK",stpm:"Program aktif; permohonan lepasan STPM melalui UPU",muet:"Mengikut syarat fakulti",extra:"3.5 tahun / 7 semester · merangkumi fonetik, fonologi, morfologi, sintaksis, semantik, sosiolinguistik dan linguistik komputeran",source:"https://www.ukm.my/studyukm/bachelor-of-social-sciences-with-honours-linguistic/"},
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Arts in English Language Studies with Honours",pngk:null,spm:"Memenuhi syarat am dan syarat khas program",stpm:"Program aktif di Centre for Research in Language and Linguistics",muet:"Mengikut syarat rasmi fakulti",extra:"Program aktif di UKM",source:"https://www.ukm.my/ppbl/programmes/programmes-offered/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Arts in English for Professionals with Honours",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Program aktif; syarat khusus perlu disemak pada portal kemasukan semasa",muet:"Mengikut syarat rasmi program",extra:"Menekankan written/spoken competence, linguistics, applied linguistics dan komunikasi profesional",source:"https://admission.usm.my/undergraduate/undergraduate-malaysian"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"LG240 English / LG241 Malay / LG242 Arabic for Professional Communication",pngk:null,spm:"Syarat khusus UiTM perlu dipenuhi",stpm:"Syarat rasmi program perlu disemak melalui UiTM/UPU",muet:"Mengikut program",extra:"Program aktif; Academy of Language Studies dikemas kini 4 September 2026",source:"https://apply-iceps.uitm.edu.my/index.php/component/sppagebuilder/?id=40&view=page"}
 ],
 matematik:[
 ...
 senipersembahan:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Music with Honours",pngk:2.00,spm:"Memenuhi syarat am SPM universiti",stpm:"Minimum Gred C (NGMP 2.00) dalam dua subjek",muet:"Band 3.0",extra:"Kelayakan muzik yang diiktiraf (contoh ABRSM/Trinity Grade 5, Yamaha Grade 7, LTCL, ATCL) atau B- Muzik SPM; temu duga dan audisi/ujian kemahiran wajib",source:"https://arts.usm.my/index.php/programmes/undergraduate"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Fine Arts (Acting and Directing) with Honours",pngk:null,spm:"Memenuhi syarat am SPM universiti",stpm:"Syarat khas program perlu disemak pada halaman rasmi USM",muet:"Tiada makluman rasmi",extra:"Audisi dan temu duga wajib",source:"https://arts.usm.my/index.php/programmes/undergraduate"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Theatre (Honours) Theatre Production",pngk:null,spm:"Memenuhi syarat am UiTM",stpm:"Syarat khas program perlu disemak pada halaman rasmi UiTM",muet:"Tiada makluman rasmi",extra:"Audisi/portfolio dan temu duga wajib",source:"https://www.uitm.edu.my/"}
 ],
 pertahanan:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Pengajian Strategi",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khusus program mengikut kategori calon",stpm:"Rujuk buku syarat kemasukan UPNM 2026–2029 untuk kombinasi gred tepat",muet:"Tiada makluman rasmi",extra:"Fokus dasar, strategi, analisis, diplomasi dan pentadbiran — tiada kandungan operasi/taktikal",source:"https://www.upnm.edu.my/index.php/bm/kemasukan/program-pengajian/pra-siswazah"},
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Pengurusan Pertahanan dan Keselamatan",pngk:null,spm:"Memenuhi syarat am dan syarat program semasa",stpm:"Rujuk buku syarat kemasukan UPNM 2026–2029",muet:"Tiada makluman rasmi",extra:"Laluan akademik pengurusan organisasi dan dasar keselamatan",source:"https://www.upnm.edu.my/index.php/en/admission-en/academic-program/undergraduate"},
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Hubungan Antarabangsa (Diplomasi dan Keselamatan Antarabangsa)",pngk:null,spm:"Memenuhi syarat am SPM dan syarat khas program",stpm:"Rujuk buku syarat kemasukan UPNM 2026–2029",muet:"Tiada makluman rasmi",extra:"Fokus diplomasi, hubungan antarabangsa dan dasar keselamatan antarabangsa",source:"https://www.upnm.edu.my/index.php/bm/kemasukan/program-pengajian/pra-siswazah"}
 ]
};
...
type AlliedHealthProgramKey="bioperubatan"|"dietetik"|"pemakanan"|"fisioterapi"|"cara_kerja"|"pengimejan"|"audiologi"|"kesihatan_persekitaran"|"optometri"|"pertuturan"|"makmal";
const alliedHealthProgramNames:Record<AlliedHealthProgramKey,string>={bioperubatan:"Sains Bioperubatan",dietetik:"Dietetik",pemakanan:"Pemakanan & Kesihatan Komuniti",fisioterapi:"Fisioterapi",cara_kerja:"Terapi Cara Kerja",pengimejan:"Pengimejan Diagnostik & Radioterapi",audiologi:"Audiologi",kesihatan_persekitaran:"Kesihatan Alam Sekitar & Pekerjaan",optometri:"Optometri",pertuturan:"Sains Pertuturan / Terapi Pertuturan-Bahasa",makmal:"Teknologi Makmal Perubatan"};
const alliedHealthComparisons:Record<AlliedHealthProgramKey,Requirement[]>={
 bioperubatan:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Biomedical Science with Honours",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khas Fakulti Sains Kesihatan",stpm:"Program aktif; syarat Malaysia khusus perlu disemak pada paparan rasmi semasa",muet:"Mengikut syarat fakulti",extra:"4 tahun · UKM Kuala Lumpur · bidang kesihatan berasaskan sains makmal dan diagnostik",source:"https://www.ukm.my/studyukm/bachelor-of-biomedical-science-with-honours/"},
  {uni:"Universiti Putra Malaysia (UPM)",program:"Bachelor of Biomedical Sciences with Honors",pngk:null,spm:"Memenuhi syarat am dan khas UPM",stpm:"Syarat khusus perlu disemak pada sesi kemasukan semasa",muet:"Mengikut syarat rasmi UPM",extra:"Program diakreditasi oleh Institute of Biomedical Science (UK); merangkumi anatomy, physiology, biotechnology, molecular biology, pharmacology, toxicology dan diagnostics",source:"https://medic.upm.edu.my/academic/undergraduate/bachelor_of_biomedical_sciences_with_honors-2485"},
  {uni:"Universiti Malaya (UM)",program:"Bachelor of Biomedical Science",pngk:3.50,spm:"Memenuhi syarat am SPM universiti",stpm:"Minimum satu A- dan dua B+ dalam Biology, Chemistry, Physics/Additional Mathematics/Mathematics",muet:"Mengikut syarat rasmi program",extra:"Ditambah Sept 2026 daripada halaman rasmi UM",source:"https://study.um.edu.my/Bachelor-of-Biomedical-Science"}
 ],
 dietetik:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Dietetics with Honours",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khas Fakulti Sains Kesihatan",stpm:"Program aktif; latar Biology/Chemistry/Mathematics/Physics diperlukan mengikut syarat fakulti",muet:"Mengikut syarat fakulti semasa",extra:"4 tahun / 8 semester · termasuk latihan pemakanan klinikal dan kaunseling pesakit",source:"https://www.ukm.my/studyukm/bachelor-of-dietetics-with-honours/"}
 ],
 ...
 optometri:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Optometry with Honours",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khas Fakulti Sains Kesihatan",stpm:"Program aktif; syarat khusus perlu disemak pada sesi semasa",muet:"Mengikut syarat fakulti",extra:"Ditambah Sept 2026 · fokus penglihatan, pemeriksaan mata dan pengurusan masalah visual",source:"https://www.ukm.my/studyukm/"}
 ],
 pertuturan:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Speech Science with Honours",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khas Fakulti Sains Kesihatan",stpm:"Program aktif; syarat khusus perlu disemak pada sesi semasa",muet:"Mengikut syarat fakulti",extra:"Ditambah Sept 2026 · fokus komunikasi, pertuturan, bahasa dan rehabilitasi",source:"https://www.ukm.my/studyukm/"}
 ],
 makmal:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Medical Laboratory Technology (Honours) — HS241",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Syarat khas program perlu disemak pada halaman rasmi UiTM",muet:"Mengikut syarat rasmi program",extra:"Ditambah Sept 2026 · fokus analisis sampel klinikal untuk membantu diagnosis",source:"https://www.uitm.edu.my/"}
 ]
};
...
type LanguageProgramKey="melayu"|"linguistik"|"english"|"translation"|"literature"|"professional";
const languageProgramNames:Record<LanguageProgramKey,string>={melayu:"Bahasa Melayu",linguistik:"Linguistik",english:"Bahasa Inggeris",translation:"Terjemahan & Bahasa Asing",literature:"Kesusasteraan",professional:"Bahasa untuk Komunikasi Profesional"};
const languageComparisons:Record<LanguageProgramKey,Requirement[]>={
 melayu:[
  {uni:"Universiti Malaya (UM)",program:"Bachelor of Professional Malay Language / Bachelor of Malay Linguistics / Bachelor of Malay Literature / Bachelor of Malay Studies",pngk:null,spm:"Memenuhi syarat am dan syarat khas Academy of Malay Studies",stpm:"Program aktif; syarat khusus perlu disemak pada halaman kemasukan semasa",muet:"Mengikut syarat rasmi UM",extra:"Empat program berasingan masih disenaraikan dalam senarai akademik UM 2025/2026",source:"https://study.um.edu.my/"},
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Arts in Malay Language Studies with Honours",pngk:null,spm:"Memenuhi syarat am UKM dan syarat khas program",stpm:"Program aktif untuk pengambilan September",muet:"Mengikut syarat program",extra:"Program disenaraikan dalam FSSK dan UKM FlexEd 2026/2027",source:"https://www.ukm.my/studyukm/faculty-of-social-sciences-and-humanities/"}
 ],
 linguistik:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Social Sciences in Linguistics with Honours",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khas FSSK",stpm:"Program aktif; permohonan lepasan STPM melalui UPU",muet:"Mengikut syarat fakulti",extra:"3.5 tahun / 7 semester · merangkumi fonetik, fonologi, morfologi, sintaksis, semantik, sosiolinguistik dan linguistik komputeran",source:"https://www.ukm.my/studyukm/bachelor-of-social-sciences-with-honours-linguistic/"},
  {uni:"Universiti Malaya (UM)",program:"Bachelor of Malay Linguistics",pngk:null,spm:"Memenuhi syarat am dan khas Academy of Malay Studies",stpm:"Program aktif; syarat sesi semasa perlu disemak",muet:"Mengikut syarat rasmi UM",extra:"Program khusus Linguistik Melayu",source:"https://study.um.edu.my/"}
 ],
 english:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Bachelor of Arts in English Language Studies with Honours",pngk:null,spm:"Memenuhi syarat am dan syarat khas program",stpm:"Program aktif di Centre for Research in Language and Linguistics",muet:"Mengikut syarat rasmi fakulti",extra:"Program aktif di UKM",source:"https://www.ukm.my/ppbl/programmes/programmes-offered/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Arts in English for Professionals with Honours",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Program aktif; syarat khusus perlu disemak pada portal kemasukan semasa",muet:"Mengikut syarat rasmi program",extra:"Menekankan written/spoken competence, linguistics, applied linguistics dan komunikasi profesional",source:"https://admission.usm.my/undergraduate/undergraduate-malaysian"}
 ...
 translation:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Foreign Languages and Translation electives / language pathway",pngk:null,spm:"Masuk melalui program bahasa/linguistik yang berkaitan",stpm:"Syarat mengikut program induk",muet:"Mengikut program induk",extra:"UKM mempunyai Foreign Languages and Translation Unit; terjemahan boleh diteroka melalui elektif dan laluan bahasa",source:"https://www.ukm.my/ppbl/programmes/programmes-offered/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"School of Languages, Literacies & Translation — undergraduate language pathways",pngk:null,spm:"Memenuhi syarat program yang dipilih",stpm:"Syarat kemasukan mengikut program",muet:"Mengikut syarat rasmi semasa",extra:"USM mempunyai School of Languages, Literacies & Translation",source:"https://admission.usm.my/undergraduate/undergraduate-malaysian"}
 ],
 literature:[
  {uni:"Universiti Malaya (UM)",program:"Bachelor of Malay Literature",pngk:null,spm:"Memenuhi syarat am dan khas Academy of Malay Studies",stpm:"Program aktif; syarat sesi semasa perlu disemak",muet:"Mengikut syarat rasmi UM",extra:"Program berasingan daripada Malay Linguistics dan Malay Studies",source:"https://study.um.edu.my/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Arts with Honours — Literature",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Literature ialah salah satu pengkhususan Bachelor of Arts with Honours",muet:"Mengikut syarat rasmi program",extra:"USM turut menawarkan English Language & Literature Studies",source:"https://admission.usm.my/undergraduate/undergraduate-malaysian"}
 ],
 professional:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"LG240 English / LG241 Malay / LG242 Arabic for Professional Communication",pngk:null,spm:"Syarat khusus UiTM perlu dipenuhi",stpm:"Syarat rasmi program perlu disemak melalui UiTM/UPU",muet:"Mengikut program",extra:"Program aktif; Academy of Language Studies dikemas kini 4 September 2026",source:"https://apply-iceps.uitm.edu.my/index.php/component/sppagebuilder/?id=40&view=page"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"LG243 English for Intercultural Communication",pngk:null,spm:"Syarat khusus program perlu dipenuhi",stpm:"Syarat kemasukan semasa melalui UiTM/UPU",muet:"Mengikut program",extra:"Program aktif di Academy of Language Studies",source:"https://apb.uitm.edu.my/index.php/programme/undergraduate"}
 ],
};
type BuiltEnvProgramKey="senibina"|"ukur_bahan"|"perancangan"|"landskap"|"geomatik"|"geoinformatik"|"pembinaan";
const builtEnvProgramNames:Record<BuiltEnvProgramKey,string>={senibina:"Seni Bina",ukur_bahan:"Ukur Bahan",perancangan:"Perancangan Bandar & Wilayah",landskap:"Seni Bina Landskap",geomatik:"Kejuruteraan Geomatik",geoinformatik:"Geoinformatik & GIS",pembinaan:"Pengurusan / Sains Pembinaan"};
const builtEnvComparisons:Record<BuiltEnvProgramKey,Requirement[]>={
 senibina:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Science in Architecture with Honours",pngk:3.00,spm:"Kepujian Matematik",stpm:"Minimum Gred B dalam mana-mana dua subjek diterima seperti Mathematics M/T, Physics, Chemistry, Biology, Geography, History, Economics, Visual Arts, Accounting, Business, ICT atau Sports Science",muet:"Band 2.0",extra:"Ujian dan temu duga wajib bagi syarat kemasukan Malaysia 2026/2027",source:"https://admission.utm.my/wp-content/uploads/sites/461/2026/02/SYARAT-KHAS-SARJANA-MUDA-UTM-SESI-20262027.pdf"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Architecture (Honours)",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Program aktif di School of Housing, Building & Planning",muet:"Mengikut syarat rasmi program",extra:"Salah satu tujuh program HBP yang ditawarkan",source:"https://en.hbp.usm.my/index.php/academics/admission"},
  {uni:"Universiti Putra Malaysia (UPM)",program:"Bachelor of Science in Architecture with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UPM",stpm:"Program aktif; syarat sesi semasa perlu disemak",muet:"Mengikut syarat rasmi UPM",extra:"Faculty of Design and Architecture",source:"https://frsb.upm.edu.my/academic/undergraduate-674"}
 ],
 ukur_bahan:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Quantity Surveying with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk intake September 2026/2027",muet:"Mengikut syarat rasmi program",extra:"Fokus cost management, procurement, contracts dan value for money",source:"https://builtsurvey.utm.my/academic/undergraduate/quantity-surveying/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Science in Quantity Surveying (Honours)",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Program aktif; UPU ialah saluran utama",muet:"Mengikut syarat rasmi semasa",extra:"Halaman kemasukan dikemas kini 3 September 2026",source:"https://admission.usm.my/index.php/course-ug/us6526001-sarjana-muda-sains-perumahan-bangunan-dan-perancangan-kepujian-ukur-bahan-upu"}
 ],
 perancangan:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Urban and Regional Planning with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk intake September 2026/2027",muet:"Mengikut syarat rasmi program",extra:"Interdisciplinary: neighbourhood, city, regional and national planning",source:"https://builtsurvey.utm.my/academic/undergraduate/urban-regional-planning/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Urban & Regional Planning (Honours)",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Program aktif di School of Housing, Building & Planning",muet:"Mengikut syarat rasmi program",extra:"Salah satu tujuh program HBP",source:"https://en.hbp.usm.my/index.php/academics/admission"}
 ],
 landskap:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Landscape Architecture with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk September 2026",muet:"Mengikut syarat rasmi program",extra:"Menggabungkan art and science dalam reka bentuk ruang luar",source:"https://builtsurvey.utm.my/academic/undergraduate/landscape-architecture/"},
  {uni:"Universiti Putra Malaysia (UPM)",program:"Bachelor of Landscape Architecture with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UPM",stpm:"Program aktif",muet:"Mengikut syarat rasmi UPM",extra:"4 tahun / 8 semester / 129 kredit",source:"https://frsb.upm.edu.my/academic/undergraduate/bachelor_of_landscape_architecture_with_honours-77862"}
 ],
 geomatik:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Geomatics Engineering with Honours",pngk:null,spm:"Kepujian Bahasa Melayu/Bahasa Malaysia mengikut syarat am UTM",stpm:"Sekurang-kurangnya Gred C dalam Pengajian Am dan Gred C dalam dua subjek lain menurut halaman program",muet:"Sekurang-kurangnya Band 1 pada halaman program; semak syarat 2026/2027 semasa",extra:"Geospatial data, satellites, remote sensing, GPS dan surveying",source:"https://builtsurvey.utm.my/academic/undergraduate/geomatic/"}
 ],
 ...
 pembinaan:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Bachelor of Science in Construction with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UTM",stpm:"Program aktif untuk September 2026",muet:"Mengikut syarat rasmi program",extra:"Program disenaraikan dalam kit intake 2026/2027",source:"https://admission.utm.my/undergraduate-kit/"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Science (Honours) (Construction Project Management)",pngk:null,spm:"Memenuhi syarat am dan khas USM",stpm:"Program aktif di HBP",muet:"Mengikut syarat rasmi program",extra:"USM turut menawarkan Building Surveying dan Building Engineering Technology",source:"https://en.hbp.usm.my/index.php/academics/admission"}
 ],
};
type HospitalityProgramKey="hospitaliti"|"pelancongan"|"acara"|"kulineri"|"perkhidmatan_makanan"|"destinasi";
const hospitalityProgramNames:Record<HospitalityProgramKey,string>={hospitaliti:"Pengurusan Hospitaliti",pelancongan:"Pengurusan Pelancongan",acara:"Pengurusan Acara",kulineri:"Seni Kulinari",perkhidmatan_makanan:"Pengurusan Perkhidmatan Makanan",destinasi:"Pengurusan Destinasi & Pelancongan Pesisir"};
const hospitalityComparisons:Record<HospitalityProgramKey,Requirement[]>={
 hospitaliti:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Science in Hospitality Management (Honours) — HM260",pngk:null,spm:"Memenuhi syarat am UiTM; syarat khas semasa perlu disemak melalui UPU/UiTM",stpm:"Program aktif pada 2026. Dokumen iCEPS 2025 menetapkan PNGK 2.00 dan Gred C dalam tiga subjek termasuk Pengajian Am; syarat ini tidak dianggap automatik untuk laluan perdana 2026",muet:"Mengikut syarat rasmi semasa",extra:"Program aktif di Faculty of Hotel and Tourism Management",source:"https://online.uitm.edu.my/degree.cfm"},
  {uni:"Universiti Utara Malaysia (UUM)",program:"Bachelor of Hospitality Management with Honours — UU6811001",pngk:null,spm:"Minimum lulus Mathematics / Additional Mathematics / Prinsip Perakaunan",stpm:"Menerima STPM Sastera atau Sains; syarat tambahan Bahasa Inggeris/MUET perlu dipenuhi",muet:"Band 3.0, atau Band 2.0 dengan sekurang-kurangnya kredit C Bahasa Inggeris SPM",extra:"8 semester",source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-hospitality-management-with-honours"}
 ],
 pelancongan:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Science in Tourism Management (Honours) — HM261",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Program aktif 2026; syarat laluan perdana perlu disemak melalui UiTM/UPU",muet:"Mengikut syarat rasmi semasa",extra:"Disenaraikan dalam program Sarjana Muda UiTM 2026",source:"https://online.uitm.edu.my/degree.cfm"},
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Bachelor of Management (Tourism) with Honours",pngk:null,spm:"Memenuhi syarat am dan khas UMT",stpm:"Program aktif; syarat khusus sesi semasa perlu disemak",muet:"Mengikut syarat rasmi UMT",extra:"6 semester / 3 tahun · fokus island and coastal tourism, MICE/event, heritage, tourism transport dan reservation systems",source:"https://www.umt.edu.my/sarjana-muda-pengurusan-pelancongan-dengan-kepujian-fpeps/"}
 ],
 acara:[
  {uni:"Universiti Utara Malaysia (UUM)",program:"Bachelor of Event Management with Honours — UU6812002",pngk:null,spm:"Minimum lulus Mathematics / Additional Mathematics / Prinsip Perakaunan",stpm:"Menerima STPM Sastera atau Sains",muet:"Band 3.0, atau Band 2.0 dengan sekurang-kurangnya kredit C Bahasa Inggeris SPM",extra:"8 semester · program berasingan daripada Hospitality Management",source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-event-management-with-honours"},
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Tourism Management — MICE/Event Management pathway",pngk:null,spm:"Memenuhi syarat program induk",stpm:"Masuk melalui Bachelor of Management (Tourism)",muet:"Mengikut syarat UMT",extra:"MICE/Event Management ialah komponen program pelancongan, bukan ijazah acara berasingan di UMT",source:"https://www.umt.edu.my/sarjana-muda-pengurusan-pelancongan-dengan-kepujian-fpeps/"}
 ],
 kulineri:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Science in Culinary Arts Management (Honours) — HM265",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Program aktif pada 2026; syarat khusus laluan perdana perlu disemak melalui UPU/UiTM",muet:"Mengikut syarat rasmi program",extra:"Menu design, advanced cooking, culinary innovation, food safety dan industrial training",source:"https://fhtm.uitm.edu.my/index.php/academics/programmes/undergraduate/culinary-arts-management"}
 ],
 perkhidmatan_makanan:[
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Science in FoodService Management (Honours) — HM262",pngk:null,spm:"Memenuhi syarat am dan khas UiTM",stpm:"Program aktif 2026; semak syarat perdana semasa",muet:"Mengikut syarat rasmi program",extra:"Program aktif di Faculty of Hotel and Tourism Management",source:"https://online.uitm.edu.my/degree.cfm"},
  {uni:"Universiti Putra Malaysia (UPM)",program:"Bachelor of Science in Food Service Management with Honours",pngk:null,spm:"Kepujian Bahasa Melayu/Bahasa Malaysia dan syarat am universiti",stpm:"Syarat am menerbitkan sekurang-kurangnya Gred C Pengajian Am dan Gred C dalam dua subjek lain; syarat khas perlu disemak semasa",muet:"Perlu mengambil MUET; band khusus mengikut syarat semasa",extra:"8 semester / 4 tahun · kerjaya termasuk F&B, service management, marketing, QA dan chef",source:"https://food.upm.edu.my/akademik/prasiswazah/bacelor_sains_pengurusan_perkhidmatan_makanan_dengan_kepujian-1149"}
 ],
 destinasi:[
  {uni:"Universiti Malaysia Terengganu (UMT)",program:"Bachelor of Management (Tourism) with Honours — destination & coastal tourism",pngk:null,spm:"Memenuhi syarat am dan khas UMT",stpm:"Syarat program sesi semasa",muet:"Mengikut syarat rasmi",extra:"Kursus termasuk Island and Coastal Tourism Planning & Development, Cultural & Heritage Tourism, Tourism Product Development dan Park & Recreation Management",source:"https://www.umt.edu.my/sarjana-muda-pengurusan-pelancongan-dengan-kepujian-fpeps/"}
 ],
};
type LogisticsProgramKey="logistik"|"pengangkutan"|"operasi"|"maritim"|"operasi_maritim"|"nautika";
const logisticsProgramNames:Record<LogisticsProgramKey,string>={logistik:"Logistik & Rantaian Bekalan",pengangkutan:"Pengangkutan",operasi:"Pengurusan Operasi",maritim:"Pengurusan Maritim",operasi_maritim:"Pengurusan Operasi Maritim",nautika:"Sains Nautika & Pengangkutan Maritim"};
const logisticsComparisons:Record<LogisticsProgramKey,Requirement[]>={
 logistik:[
  {uni:"Universiti Utara Malaysia (UUM)",program:"Bachelor of Business Administration (Logistics and Transportation) with Honours — UU6840001",pngk:null,spm:"Kredit C Mathematics/Additional Mathematics, atau lulus Mathematics/Add Mathematics + kredit C dalam Accounting/Economics/Commerce/Business",stpm:"Menerima STPM Sastera atau Sains; syarat penuh mengikut halaman rasmi program",muet:"Band 3.0, atau Band 2.0 bersama kredit Bahasa Inggeris SPM",extra:"8 semester",source:"https://www.uum.edu.my/admissions/application-guidelines/undergraduate-local/local/bachelor-of-business-administration-logistics-and-transportation-with-honours"}
 ],
 pengangkutan:[
...
type HealthProfessionalProgramKey="perubatan"|"pergigian"|"farmasi"|"kejururawatan";
const healthProfessionalProgramNames:Record<HealthProfessionalProgramKey,string>={perubatan:"Perubatan",pergigian:"Pergigian",farmasi:"Farmasi",kejururawatan:"Kejururawatan"};
const healthProfessionalComparisons:Record<HealthProfessionalProgramKey,Requirement[]>={
 perubatan:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Doktor Perubatan",pngk:3.80,spm:"Minimum B: Biologi, Kimia, Fizik, Matematik/Matematik Tambahan dan 1 subjek lain",stpm:"Minimum B: Biologi, Kimia dan Fizik/Mathematics",muet:"Tiada makluman rasmi bagi laluan STPM",extra:"Temu duga wajib",source:"https://www.ukm.my/sppfper/wp-content/uploads/2023/03/Medicine-2023-UPU_compressed.pdf"},
  {uni:"Universiti Sains Malaysia (USM)",program:"Doktor Perubatan (MD)",pngk:3.50,spm:"Syarat khusus Sains dan Matematik",stpm:"Kombinasi subjek Sains yang ditetapkan",muet:"Band 3.0",extra:"Temu duga wajib; pemilihan sangat kompetitif",source:"https://admission.usm.my/"},
  {uni:"Universiti Putra Malaysia (UPM)",program:"Doktor Perubatan",pngk:null,spm:"Subjek Sains dan Matematik tertakluk syarat khas program",stpm:"Biologi, Kimia dan Fizik/Mathematics",muet:"Tiada makluman rasmi",extra:"Ujian/temu duga jika ditetapkan",source:"https://medic.upm.edu.my/"}
 ],
 pergigian:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Doctor of Dental Surgery (DDS)",pngk:3.50,spm:"Minimum B: Biologi, Kimia, Fizik, Matematik/Matematik Tambahan dan 1 subjek lain",stpm:"Minimum Gred B (CGPA 3.00) dalam Biology, Chemistry, Physics/Mathematics T",muet:"Band 3.5",extra:"Temu duga wajib; program 5 tahun",source:"https://admission.usm.my/index.php/undergraduate/undergraduate-malaysian?view=article&id=651&catid=67"},
  {uni:"Universiti Malaya (UM)",program:"Bachelor of Dental Surgery",pngk:null,spm:"Syarat khusus Sains dan Matematik",stpm:"Kombinasi subjek Sains yang ditetapkan",muet:"Tiada makluman rasmi",extra:"Ujian/temu duga mengikut ketetapan",source:"https://study.um.edu.my/"}
 ],
 farmasi:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Sarjana Muda Farmasi",pngk:3.50,spm:"Syarat Sains khusus perlu dipenuhi",stpm:"Biologi, Kimia dan Fizik/Mathematics mengikut syarat khas; PNGK minimum rasmi lazimnya 3.50 ke atas",muet:"Tiada makluman rasmi",extra:"Nota merit: sumber sekunder (myupu.my) melaporkan merit sebenar pemohon berjaya sesi terkini pada kelompok CGPA 3.85+ dengan A dalam Biologi/Kimia/Fizik — antara paling tinggi di Malaysia; ini ialah tahap persaingan sebenar, bukan syarat minimum rasmi. Ujian dan temu duga turut disyaratkan.",source:"https://www.ukm.my/portal/undergraduate-programmes/"},
  {uni:"Universiti Malaya (UM)",program:"Sarjana Muda Farmasi",pngk:3.80,spm:"Minimum B dalam Bahasa Inggeris, Biologi, Kimia, Fizik dan Matematik/Matematik Tambahan",stpm:"2A dan 1A- dalam Biologi, Kimia dan Fizik/Mathematics",muet:"Band 3.0",extra:"Ujian dan temu duga. Nota: kad bidang kerjaya Farmasi berasingan (key farmasi) turut memaparkan baris ini.",source:"https://study.um.edu.my/bachelor-of-pharmacy-with-honours"}
 ],
 kejururawatan:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Nursing with Honours",pngk:2.50,spm:"Kredit Bahasa Inggeris dan Matematik/Matematik Tambahan",stpm:"Minimum Gred C (NGMP 2.00) dalam mana-mana dua daripada Biology, Chemistry, Physics, Mathematics T",muet:"Band 3.0",extra:"Temu duga wajib",source:"https://admission.usm.my/index.php/undergraduate/undergraduate-malaysian?view=article&id=659&catid=67"}
 ]
};
type ComputingProgramKey="sains_komputer"|"perisian"|"ai"|"data"|"keselamatan"|"sistem_maklumat"|"rangkaian"|"multimedia";
const computingProgramNames:Record<ComputingProgramKey,string>={sains_komputer:"Sains Komputer",perisian:"Kejuruteraan Perisian",ai:"Kecerdasan Buatan (AI)",data:"Sains Data & Kejuruteraan Data",keselamatan:"Keselamatan Siber / Keselamatan Komputer",sistem_maklumat:"Sistem Maklumat",rangkaian:"Rangkaian Komputer",multimedia:"Multimedia, Media Interaktif & Cloud"};
const computingComparisons:Record<ComputingProgramKey,Requirement[]>={
 sains_komputer:[
  {uni:"Universiti Kebangsaan Malaysia (UKM)",program:"Sarjana Muda Sains Komputer",pngk:2.50,spm:"Matematik/Matematik Tambahan dan subjek Sains/ICT berkaitan",stpm:"Mathematics dan subjek Sains yang diterima",muet:"Tiada makluman rasmi",extra:"Ujian/temu duga bagi program bertanda #",source:"https://www.ukm.my/portal/undergraduate-programmes/"},
  {uni:"Universiti Teknikal Malaysia Melaka (UTeM)",program:"Ijazah Sarjana Muda Sains Komputer dengan Kepujian",pngk:2.00,spm:"Kepujian Bahasa Melayu dan lulus Sejarah",stpm:"Minimum C dalam Mathematics (M/T) dan satu subjek Fizik, Kimia atau Biologi",muet:"Band 2.0",extra:"Sumber rasmi sesi 2026/2027",source:"https://www.utem.edu.my/en/downloads/kemasukan/242-sesi-20262027-lepasan-stpm-syarat-kemasukan-prasiswazah.html"}
 ],
 perisian:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Sarjana Muda Kejuruteraan Perisian",pngk:2.80,spm:"Matematik/Matematik Tambahan dan subjek Sains berkaitan",stpm:"Mathematics dan kombinasi subjek Sains yang ditetapkan",muet:"Tiada makluman rasmi",extra:"Rujuk e-Panduan untuk kod program tepat",source:"https://upu.mohe.gov.my/"},
  {uni:"Universiti Teknikal Malaysia Melaka (UTeM)",program:"Ijazah Sarjana Muda Kejuruteraan Perisian dengan Kepujian",pngk:2.00,spm:"Kepujian Bahasa Melayu dan lulus Sejarah",stpm:"Minimum C dalam Mathematics (M/T) dan satu subjek Sains yang ditetapkan",muet:"Band 2.0",extra:"Sumber rasmi sesi 2026/2027",source:"https://www.utem.edu.my/en/downloads/kemasukan/242-sesi-20262027-lepasan-stpm-syarat-kemasukan-prasiswazah.html"}
 ],
 ai:[
  {uni:"Universiti Teknikal Malaysia Melaka (UTeM)",program:"Ijazah Sarjana Muda Sains Komputer (Kepintaran Buatan) dengan Kepujian",pngk:2.00,spm:"Kepujian Bahasa Melayu dan lulus Sejarah",stpm:"Minimum C dalam Mathematics (M/T) dan satu subjek Fizik, Kimia atau Biologi",muet:"Band 2.0",extra:"Kod UC6481005 / BAXI · Fakulti Kecerdasan Buatan dan Keselamatan Siber",source:"https://www.utem.edu.my/en/downloads/kemasukan/242-sesi-20262027-lepasan-stpm-syarat-kemasukan-prasiswazah.html"},
  {uni:"Universiti Malaya (UM)",program:"Sarjana Muda Kecerdasan Buatan",pngk:null,spm:"Minimum B dalam Matematik/Matematik Tambahan dan 1 subjek Sains/ICT",stpm:"Syarat khas program perlu disemak pada halaman rasmi UM",muet:"Tiada makluman rasmi",extra:"Aliran Sains",source:"https://study.um.edu.my/"}
 ],
 data:[
  {uni:"Universiti Teknologi Malaysia (UTM)",program:"Sarjana Muda Kejuruteraan Data",pngk:2.80,spm:"Matematik/Matematik Tambahan dan subjek Sains berkaitan",stpm:"Mathematics dan kombinasi subjek Sains yang ditetapkan",muet:"Tiada makluman rasmi",extra:"Rujuk e-Panduan untuk kod program tepat",source:"https://upu.mohe.gov.my/"},
  {uni:"Universiti Malaya (UM)",program:"Sarjana Muda Sains Data",pngk:null,spm:"Minimum B dalam Matematik/Matematik Tambahan dan 1 subjek Sains/ICT",stpm:"Syarat khas program perlu disemak pada halaman rasmi UM",muet:"Tiada makluman rasmi",extra:"Aliran Sains",source:"https://study.um.edu.my/"}
 ],
 keselamatan:[
  {uni:"Universiti Teknikal Malaysia Melaka (UTeM)",program:"Ijazah Sarjana Muda Sains Komputer (Keselamatan Komputer) dengan Kepujian",pngk:2.00,spm:"Kepujian Bahasa Melayu dan lulus Sejarah",stpm:"Minimum C dalam Mathematics (M/T) dan satu subjek Fizik, Kimia atau Biologi",muet:"Band 2.0",extra:"Kod UC6481006 / BAXZ · Fakulti Kecerdasan Buatan dan Keselamatan Siber",source:"https://www.utem.edu.my/en/downloads/kemasukan/242-sesi-20262027-lepasan-stpm-syarat-kemasukan-prasiswazah.html"}
 ],
 sistem_maklumat:[
  {uni:"Universiti Malaya (UM)",program:"Sarjana Muda Sistem Maklumat",pngk:null,spm:"Minimum B dalam Matematik/Matematik Tambahan dan 1 subjek Sains/ICT",stpm:"Syarat khas program perlu disemak pada halaman rasmi UM",muet:"Tiada makluman rasmi",extra:"Aliran Sains",source:"https://study.um.edu.my/"}
 ],
 rangkaian:[
  {uni:"Universiti Teknikal Malaysia Melaka (UTeM)",program:"Ijazah Sarjana Muda Rangkaian Komputer dengan Kepujian",pngk:2.00,spm:"Kepujian Bahasa Melayu dan lulus Sejarah",stpm:"Minimum C dalam Mathematics (M/T) dan satu subjek Sains yang ditetapkan",muet:"Band 2.0",extra:"Sumber rasmi sesi 2026/2027",source:"https://www.utem.edu.my/en/downloads/kemasukan/242-sesi-20262027-lepasan-stpm-syarat-kemasukan-prasiswazah.html"},
  {uni:"Universiti Malaya (UM)",program:"Sarjana Muda Rangkaian Komputer",pngk:null,spm:"Minimum B dalam Matematik/Matematik Tambahan dan 1 subjek Sains/ICT",stpm:"Syarat khas program perlu disemak pada halaman rasmi UM",muet:"Tiada makluman rasmi",extra:"Aliran Sains",source:"https://study.um.edu.my/"}
 ],
 multimedia:[
  {uni:"Universiti Teknikal Malaysia Melaka (UTeM)",program:"Ijazah Sarjana Muda Multimedia dengan Kepujian",pngk:2.00,spm:"Kepujian Bahasa Melayu dan lulus Sejarah",stpm:"Minimum C dalam Mathematics (M/T) dan satu subjek Sains yang ditetapkan",muet:"Band 2.0",extra:"Sumber rasmi sesi 2026/2027; meliputi media interaktif dan pengkomputeran awan",source:"https://www.utem.edu.my/en/downloads/kemasukan/242-sesi-20262027-lepasan-stpm-syarat-kemasukan-prasiswazah.html"},
  {uni:"Universiti Malaya (UM)",program:"Sarjana Muda Multimedia",pngk:null,spm:"Minimum B dalam Matematik/Matematik Tambahan dan 1 subjek Sains/ICT",stpm:"Syarat khas program perlu disemak pada halaman rasmi UM",muet:"Tiada makluman rasmi",extra:"Aliran Sains",source:"https://study.um.edu.my/"}
 ]
};
type PerformingArtsProgramKey="muzik"|"lakonan"|"teater"|"filem"|"pengurusan_seni";
const performingArtsProgramNames:Record<PerformingArtsProgramKey,string>={muzik:"Muzik",lakonan:"Lakonan & Pengarahan",teater:"Teater & Produksi",filem:"Filem / Produksi Skrin",pengurusan_seni:"Pengurusan Seni & Produksi"};
const performingArtsComparisons:Record<PerformingArtsProgramKey,Requirement[]>={
 muzik:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Music with Honours",pngk:2.00,spm:"Memenuhi syarat am SPM universiti",stpm:"Minimum Gred C (NGMP 2.00) dalam dua subjek",muet:"Band 3.0",extra:"Kelayakan muzik yang diiktiraf (ABRSM/Trinity Grade 5, Yamaha Grade 7, LTCL, ATCL) atau B- Muzik SPM; temu duga dan audisi wajib",source:"https://arts.usm.my/index.php/programmes/undergraduate"}
 ],
 lakonan:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Fine Arts (Acting and Directing) with Honours",pngk:null,spm:"Memenuhi syarat am SPM universiti",stpm:"Syarat khas program perlu disemak pada halaman rasmi USM",muet:"Tiada makluman rasmi",extra:"Audisi dan temu duga wajib",source:"https://arts.usm.my/index.php/programmes/undergraduate"}
 ],
 ...
 filem:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Fine Arts (Acting and Directing) with Honours — trek Skrin",pngk:null,spm:"Memenuhi syarat am SPM universiti",stpm:"Syarat khas program perlu disemak pada halaman rasmi USM",muet:"Tiada makluman rasmi",extra:"Audisi dan temu duga wajib",source:"https://arts.usm.my/index.php/programmes/undergraduate"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Theatre (Honours) Theatre Production — trek Filem",pngk:null,spm:"Memenuhi syarat am UiTM",stpm:"Syarat khas program perlu disemak pada halaman rasmi UiTM",muet:"Tiada makluman rasmi",extra:"Audisi/portfolio dan temu duga wajib",source:"https://www.uitm.edu.my/"}
 ],
 pengurusan_seni:[
  {uni:"Universiti Sains Malaysia (USM)",program:"Bachelor of Music with Honours — trek pengurusan produksi",pngk:2.00,spm:"Memenuhi syarat am SPM universiti",stpm:"Minimum Gred C (NGMP 2.00) dalam dua subjek",muet:"Band 3.0",extra:"Temu duga dan audisi wajib",source:"https://arts.usm.my/index.php/programmes/undergraduate"},
  {uni:"Universiti Teknologi MARA (UiTM)",program:"Bachelor of Theatre (Honours) Theatre Production — trek pengurusan",pngk:null,spm:"Memenuhi syarat am UiTM",stpm:"Syarat khas program perlu disemak pada halaman rasmi UiTM",muet:"Tiada makluman rasmi",extra:"Audisi/portfolio dan temu duga wajib",source:"https://www.uitm.edu.my/"}
 ]
};
type UpnmStrategyProgramKey="strategi"|"pengurusan_pertahanan"|"sumber_manusia"|"antarabangsa"|"keselamatan_global"|"logistik_pertahanan";
const upnmStrategyProgramNames:Record<UpnmStrategyProgramKey,string>={strategi:"Pengajian Strategi",pengurusan_pertahanan:"Pengurusan Pertahanan & Keselamatan",sumber_manusia:"Pengurusan Sumber Manusia Pertahanan",antarabangsa:"Hubungan Antarabangsa (Diplomasi & Keselamatan Antarabangsa)",keselamatan_global:"Keselamatan Global & Analitik",logistik_pertahanan:"Rantaian Bekalan & Logistik"};
const upnmStrategyComparisons:Record<UpnmStrategyProgramKey,Requirement[]>={
 strategi:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Pengajian Strategi",pngk:null,spm:"Memenuhi syarat am universiti dan syarat khusus program mengikut kategori calon.",stpm:"UPNM menyenaraikan program ini pada penawaran prasiswazah semasa. Syarat STPM khusus perlu dirujuk dalam buku syarat 2026–2029.",muet:"Tiada makluman rasmi pada ringkasan program.",extra:"Fokus portal: dasar, strategi, analisis, diplomasi dan pentadbiran. Tiada kandungan operasi/taktikal.",source:"https://www.upnm.edu.my/index.php/bm/kemasukan/program-pengajian/pra-siswazah"}
 ],
 pengurusan_pertahanan:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Pengurusan Pertahanan dan Keselamatan",pngk:null,spm:"Memenuhi syarat am dan syarat program semasa.",stpm:"Program disenaraikan dalam penawaran prasiswazah semasa; rujuk buku syarat rasmi 2026–2029 untuk kombinasi STPM.",muet:"Tiada makluman rasmi",extra:"Laluan akademik merangkumi pengurusan organisasi, dasar keselamatan dan pentadbiran.",source:"https://www.upnm.edu.my/index.php/en/admission-en/academic-program/undergraduate"}
 ],
 sumber_manusia:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Pengurusan Sumber Manusia Pertahanan",pngk:null,spm:"Memenuhi syarat am universiti.",stpm:"Program aktif dalam Fakulti Pengurusan dan Pertahanan; syarat khusus STPM perlu disemak melalui dokumen kemasukan semasa.",muet:"Tiada makluman rasmi",extra:"Sesuai untuk laluan HR, latihan, pembangunan organisasi dan pentadbiran.",source:"https://www.upnm.edu.my/index.php/en/admission-en/academic-program/undergraduate"}
 ],
 antarabangsa:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Hubungan Antarabangsa (Diplomasi dan Keselamatan Antarabangsa)",pngk:null,spm:"Memenuhi syarat am SPM dan syarat khas program.",stpm:"Program disenaraikan secara rasmi; kombinasi subjek STPM perlu disahkan melalui buku syarat 2026–2029.",muet:"Tiada makluman rasmi",extra:"Fokus akademik: diplomasi, hubungan antarabangsa, dasar dan keselamatan antarabangsa. Nota pertindihan: berkait rapat dengan bidang Pentadbiran Awam, Politik & Hubungan Antarabangsa (key pentadbiran).",source:"https://www.upnm.edu.my/index.php/bm/kemasukan/program-pengajian/pra-siswazah"}
 ],
 keselamatan_global:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Sains (Kepujian) Kepolisan, Keselamatan Global dan Perisikan",pngk:null,spm:"Memenuhi syarat am dan syarat khas program.",stpm:"Program disenaraikan secara rasmi; syarat gred khusus perlu dirujuk pada buku syarat 2026–2029.",muet:"Tiada makluman rasmi",extra:"Dalam portal, bidang ini dipaparkan sebagai analitik keselamatan, dasar awam, penyelidikan dan pentadbiran — bukan latihan operasi.",source:"https://www.upnm.edu.my/index.php/en/admission-en/academic-program/undergraduate"}
 ],
 logistik_pertahanan:[
  {uni:"Universiti Pertahanan Nasional Malaysia (UPNM)",program:"Sarjana Muda Pengurusan Rantaian Bekalan dan Logistik dengan Kepujian",pngk:null,spm:"Memenuhi syarat am universiti.",stpm:"Program disenaraikan secara rasmi. Syarat khusus mengikut kategori calon perlu disemak pada buku syarat semasa.",muet:"Tiada makluman rasmi",extra:"Laluan kerjaya termasuk logistik, perolehan, rantaian bekalan dan pengurusan operasi. Nota pertindihan: berkait rapat dengan bidang Logistik, Pengangkutan & Maritim (key logistik) yang memfokus laluan awam/komersial.",source:"https://www.upnm.edu.my/index.php/en/admission-en/academic-program/undergraduate"}
 ]
};
...
export default function LaluanPage(){
 ...
 const [selectedLanguage,setSelectedLanguage]=useState<LanguageProgramKey>("melayu");
 const [selectedBuiltEnv,setSelectedBuiltEnv]=useState<BuiltEnvProgramKey>("senibina");
 const [selectedHospitality,setSelectedHospitality]=useState<HospitalityProgramKey>("hospitaliti");
 const [selectedLogistics,setSelectedLogistics]=useState<LogisticsProgramKey>("logistik");
 const [selectedHealthProfessional,setSelectedHealthProfessional]=useState<HealthProfessionalProgramKey>("perubatan");
 const [selectedComputing,setSelectedComputing]=useState<ComputingProgramKey>("sains_komputer");
 const [selectedPerformingArts,setSelectedPerformingArts]=useState<PerformingArtsProgramKey>("muzik");
 const [selectedUpnmStrategy,setSelectedUpnmStrategy]=useState<UpnmStrategyProgramKey>("strategi");
 const [spmGrades,setSpmGrades]=useState<Record<string,Grade|"">>({});
 const item=careers[selected]; const requirements=selected==="peguam"?lawComparisons[selectedLaw]:selected==="jurutera"?engineeringComparisons[selectedEngineering]:selected==="guru"?educationComparisons[selectedEducation]:selected==="akauntan"?financeComparisons[selectedFinance]:selected==="matematik"?mathComparisons[selectedMath]:selected==="sains"?scienceComparisons[selectedScience]:selected==="perniagaan"?businessComparisons[selectedBusiness]:selected==="psikologi"?humanComparisons[selectedHuman]:selected==="sosial"?socialHumanitiesComparisons[selectedSocial]:selected==="media"?mediaComparisons[selectedMedia]:selected==="pentadbiran"?publicAffairsComparisons[selectedPublicAffairs]:selected==="pertanian"?agroFoodComparisons[selectedAgroFood]:selected==="veterinar"?vetAnimalComparisons[selectedVetAnimal]:selected==="alam"?environmentComparisons[selectedEnvironment]:selected==="marin"?marineComparisons[selectedMarine]:selected==="kerjasosial"?socialWorkComparisons[selectedSocialWork]:selected==="maklumat"?infoScienceComparisons[selectedInfoScience]:selected==="kreatif"?creativeComparisons[selectedCreative]:selected==="kesihatanbersekutu"?alliedHealthComparisons[selectedAlliedHealth]:selected==="sukan"?sportComparisons[selectedSport]:selected==="islam"?islamicStudiesComparisons[selectedIslamicStudies]:selected==="bahasa"?languageComparisons[selectedLanguage]:selected==="bina"?builtEnvComparisons[selectedBuiltEnv]:selected==="hospitaliti"?hospitalityComparisons[selectedHospitality]:selected==="logistik"?logisticsComparisons[selectedLogistics]:selected==="doktor"?healthProfessionalComparisons[selectedHealthProfessional]:selected==="teknologi"?computingComparisons[selectedComputing]:selected==="senipersembahan"?performingArtsComparisons[selectedPerformingArts]:selected==="pertahanan"?upnmStrategyComparisons[selectedUpnmStrategy]:comparisons[selected]; const packageItem=packages[selectedPackage];
 ...
 return <main className="simple-page"><div className="simple-shell wide career-shell">
  ...
  {selected==="bahasa"&&<section className="career-picker"><label htmlFor="language-program">Subprogram Bahasa, Linguistik & Terjemahan untuk dibandingkan</label><select id="language-program" value={selectedLanguage} onChange={e=>{setSelectedLanguage(e.target.value as LanguageProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(languageProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="bina"&&<section className="career-picker"><label htmlFor="builtenv-program">Subprogram Alam Bina untuk dibandingkan</label><select id="builtenv-program" value={selectedBuiltEnv} onChange={e=>{setSelectedBuiltEnv(e.target.value as BuiltEnvProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(builtEnvProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="hospitaliti"&&<section className="career-picker"><label htmlFor="hospitality-program">Subprogram Hospitaliti & Pelancongan untuk dibandingkan</label><select id="hospitality-program" value={selectedHospitality} onChange={e=>{setSelectedHospitality(e.target.value as HospitalityProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(hospitalityProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="logistik"&&<section className="career-picker"><label htmlFor="logistics-program">Subprogram Logistik, Pengangkutan & Maritim untuk dibandingkan</label><select id="logistics-program" value={selectedLogistics} onChange={e=>{setSelectedLogistics(e.target.value as LogisticsProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(logisticsProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="doktor"&&<section className="career-picker"><label htmlFor="healthprofessional-program">Subprogram Perubatan & Kesihatan untuk dibandingkan</label><select id="healthprofessional-program" value={selectedHealthProfessional} onChange={e=>{setSelectedHealthProfessional(e.target.value as HealthProfessionalProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(healthProfessionalProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="teknologi"&&<section className="career-picker"><label htmlFor="computing-program">Subprogram Komputer, Data & AI untuk dibandingkan</label><select id="computing-program" value={selectedComputing} onChange={e=>{setSelectedComputing(e.target.value as ComputingProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(computingProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="senipersembahan"&&<section className="career-picker"><label htmlFor="performingarts-program">Subprogram Seni Persembahan & Muzik untuk dibandingkan</label><select id="performingarts-program" value={selectedPerformingArts} onChange={e=>{setSelectedPerformingArts(e.target.value as PerformingArtsProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(performingArtsProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  {selected==="pertahanan"&&<section className="career-picker"><label htmlFor="upnmstrategy-program">Subprogram Pengajian Strategik, Pertahanan & Keselamatan untuk dibandingkan</label><select id="upnmstrategy-program" value={selectedUpnmStrategy} onChange={e=>{setSelectedUpnmStrategy(e.target.value as UpnmStrategyProgramKey);setSelectedRequirement(0);setSpmGrades({})}}>{Object.entries(upnmStrategyProgramNames).map(([key,name])=><option key={key} value={key}>{name}</option>)}</select></section>}
  <section className="uni-compare">
   <div className="compare-heading"><div><small>SYARAT KHAS PROGRAM · SESI 2026/2027</small><h2>{selected==="jurutera"?`${engineeringProgramNames[selectedEngineering]} — universiti yang telah disahkan`:selected==="peguam"?`${lawProgramNames[selectedLaw]} — universiti yang telah disahkan`:selected==="guru"?`${educationProgramNames[selectedEducation]} — universiti yang telah disahkan`:selected==="akauntan"?`${financeProgramNames[selectedFinance]} — universiti yang telah disahkan`:selected==="matematik"?`${mathProgramNames[selectedMath]} — universiti yang telah disahkan`:selected==="sains"?`${scienceProgramNames[selectedScience]} — universiti yang telah disahkan`:selected==="perniagaan"?`${businessProgramNames[selectedBusiness]} — universiti yang telah disahkan`:selected==="psikologi"?`${humanProgramNames[selectedHuman]} — universiti yang telah disahkan`:selected==="sosial"?`${socialHumanitiesProgramNames[selectedSocial]} — universiti yang telah disahkan`:selected==="media"?`${mediaProgramNames[selectedMedia]} — universiti yang telah disahkan`:selected==="pentadbiran"?`${publicAffairsProgramNames[selectedPublicAffairs]} — universiti yang telah disahkan`:selected==="pertanian"?`${agroFoodProgramNames[selectedAgroFood]} — universiti yang telah disahkan`:selected==="veterinar"?`${vetAnimalProgramNames[selectedVetAnimal]} — universiti yang telah disahkan`:selected==="alam"?`${environmentProgramNames[selectedEnvironment]} — universiti yang telah disahkan`:selected==="marin"?`${marineProgramNames[selectedMarine]} — universiti yang telah disahkan`:selected==="kerjasosial"?`${socialWorkProgramNames[selectedSocialWork]} — universiti yang telah disahkan`:selected==="maklumat"?`${infoScienceProgramNames[selectedInfoScience]} — universiti yang telah disahkan`:selected==="kreatif"?`${creativeProgramNames[selectedCreative]} — universiti yang telah disahkan`:selected==="kesihatanbersekutu"?`${alliedHealthProgramNames[selectedAlliedHealth]} — universiti yang telah disahkan`:selected==="sukan"?`${sportProgramNames[selectedSport]} — universiti yang telah disahkan`:selected==="islam"?`${islamicStudiesProgramNames[selectedIslamicStudies]} — universiti yang telah disahkan`:selected==="bahasa"?`${languageProgramNames[selectedLanguage]} — universiti yang telah disahkan`:selected==="bina"?`${builtEnvProgramNames[selectedBuiltEnv]} — universiti yang telah disahkan`:selected==="hospitaliti"?`${hospitalityProgramNames[selectedHospitality]} — universiti yang telah disahkan`:selected==="logistik"?`${logisticsProgramNames[selectedLogistics]} — universiti yang telah disahkan`:selected==="doktor"?`${healthProfessionalProgramNames[selectedHealthProfessional]} — universiti yang telah disahkan`:selected==="teknologi"?`${computingProgramNames[selectedComputing]} — universiti yang telah disahkan`:selected==="senipersembahan"?`${performingArtsProgramNames[selectedPerformingArts]} — universiti yang telah disahkan`:selected==="pertahanan"?`${upnmStrategyProgramNames[selectedUpnmStrategy]} — universiti yang telah disahkan`:"Universiti yang menawarkan program berkaitan"}</h2><p>{selected==="jurutera"?"Hanya rekod dengan syarat program yang dapat disahkan daripada halaman rasmi semasa dipaparkan. Universiti lain akan ditambah selepas dokumen programnya disahkan.":"Angka khusus dipaparkan apabila diterbitkan oleh universiti. Syarat khas program tetap wajib dipenuhi."}</p></div><a href="https://upu.mohe.gov.my/PEKELILING%20KEMASUKAN%20STPM_MATRIK_ASASI_STAM%20KE%20UNIVERSITI%20AWAM%20SESI%20AKADEMIK%202627.pdf" target="_blank" rel="noopener noreferrer">Pekeliling rasmi 2026/2027 <ExternalLink/></a></div>
